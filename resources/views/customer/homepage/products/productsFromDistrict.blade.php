<div class="w-full bg-slate-50 dark:bg-slate-800 text-slate800 dark:text-slate-200 py-2">
    <div class="container mx-auto">
        ...
        <div
            class="grid product-district-grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-2">
            @for ($i = 0; $i < 30; $i++)
    ...
    <script>
        function replaceDistrictProducts(products) {
            var productContainer = $(".product-district-grid");
            productContainer.empty();
            products.forEach(product => {
                //replace products in above grid ?
