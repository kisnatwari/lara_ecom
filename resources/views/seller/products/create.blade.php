                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative mt-1">
                            <div class="absolute top-0 left-0 z-10 w-full bg-slate-800/50 max-h-[350px] overflow-auto backdrop-blur-lg"
                                id="categories-list">
                    ...
                    <div class="flex justify-between">
                        <div
                            class="w-24 h-24 flex justify-center items-center shadow-lg bg-slate-800/40 border-2 border-slate-400/80 border-dashed rounded-md relative z-0 overflow-hidden cursor-pointer">
                        ...
                        <div
                            ...
                            <input type="file" name="images[]" onchange="changeBackground(this)"
                                class="absolute top-0 left-0 cursor-pointer opacity-0 w-full h-full">
                        </div>
                        <div
                            class="w-24 h-24 flex justify-center items-center shadow-lg bg-slate-800/40 border-2 border-slate-400/80 border-dashed rounded-md relative overflow-auto">
